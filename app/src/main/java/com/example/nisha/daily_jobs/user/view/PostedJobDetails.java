...
class JobPostings {
    ...
    public JobPostings(@NonNull String id, @NonNull String jobTitle,@NonNull String jobDesc,@NonNull String jobLocation,String timeDuration,@NonNull String payPerHour, String jobStartDate,
...
public class PostedJobDetails extends Fragment  {
    private ExpandableListView expandableListView;
    private ArrayList<JobPostings> jobDetails;
    Fragment myfragment;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        jobDetails=new ArrayList<JobPostings>();
            EmployerHistory jobsQuery=new EmployerHistory();
            for(ParseObject o:jobsQuery.getAllJobs()) {
                JobPostings _jd = new JobPostings(o.getObjectId(), o.getString("jobName"), o.getString("jobDesc"), o.getString("jobLocation"),
        ...
        for(JobPostings jd:jobDetails){
            ...
            _temp.add("Time Duration: "+jd.gettimeDuration());
